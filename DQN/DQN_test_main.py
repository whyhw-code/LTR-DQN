...
if __name__ == '__main__':
    ...
    env = Environment(data, temp_data, start_date=20220815, end_date=20230303)#1022
    ...
    agent = Agent(gamma=0.9, epsilon=0.03, batch_size=24, n_actions=5, eps_end=0.03, eps_dec=0.0001, input_dims=[13], lr=0.002, fc1_dims=256,fc2_dims=128)
