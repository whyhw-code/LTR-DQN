...
temp.to_csv(f'temp/batch{test_batch}/aaaaaa{dapan_code}temp_{train_or_test}_{m}_train{train_year}.csv')
...
if train_or_test == 'test':
    ...
    result.to_csv(f'end//batch{test_batch}/aaaaaaaa{dapan_code}return_{train_or_test}_{m}_train{train_year}.csv', index=False) *)
