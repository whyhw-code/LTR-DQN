...
if Reg_or_Class == 'xgbreg':
    ...
    model_best = xgb.XGBClassifier(objective='reg:squarederror', booster='gbtree', tree_method='gpu_hist', n_estimators=150,max_depth=4,learning_rate=0.1, subsample=1.0,colsample_bytree=0.8)
...
# temp.to_csv(f'temp/oc/batch{test_batch}/{dapan_code}temp_test_{Reg_or_Class}_train{train_year}.csv') #输出图5记录不同时间结果
